...
public class Oval extends abstractShape {
    ...
    public void draw(Graphics canvas) {
        ...
        canvas.fillOval((int) getPosition().getX(), (int) getPosition().getY(), width, height);
        canvas.setColor(this.getColor());
        canvas.drawOval((int) getPosition().getX(), (int) getPosition().getY(), width, height);
         if (isSelected()) { //sa7???
    ...
    public boolean contains(Point p) {
        ...
        Ellipse2D.Float e = new Ellipse2D.Float(getPosition().x, getPosition().y, width, height);
        return e.contains(p);
    }
 ...
 @Override
    ...
    protected Object clone() throws CloneNotSupportedException {
        ...
        Oval c = new Oval(width,height,pos);
        c.setColor(getColor());
